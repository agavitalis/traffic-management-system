                        ...
                        <div class="x_content">
                           ...
                           These are the summary of all the transactions made (You can print the receipt of each payment).
                            ...
                            <tbody>
                                ...
                                <td> <a href="/emblem_receipt/{{$transaction->id}}" title="Print the receipt of this Transaction" class="btn btn-success btn-flat btn-sm"><i class="fa fa-print"></i> Print Recipt</a></td>
