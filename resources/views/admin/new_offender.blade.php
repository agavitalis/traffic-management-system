          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i>Log a new offenders <small>( offenders fields must be filled accordingly)</small></h2>
                      ...
                      <div id="myTabContent" class="tab-content">
                         <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                             ...
                             <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="POST" action="{{ route('admin_log_offenders')}}">

                                     {{ csrf_field() }}
                                    <input type="hidden" name="action" value="log_rule">

                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <input type="text" required="" class="form-control" name="vehicle" placeholder="Vehicle ID" >
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <select class="form-control" name="offence">
                                            ...
                                            <option value="{{$rule->rule_id}}" >Rule ID: {{$rule->rule_id}} || {{$rule->rule_name}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12 col-xs-12 pull-right">
                                            ...
                                            <button type="submit" class="btn btn-success  pull-right">Log Offender</button>
                                        </div>
                                    </div>
